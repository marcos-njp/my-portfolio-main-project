...
import { ChatFeaturesModal } from "@/components/ai-chat/chat-features-modal"
            ...
            <div className="max-w-4xl mx-auto">
              <div className="mb-8">
                ...
                <p className="text-sm text-muted-foreground">
                  Chat with an AI assistant trained on my professional background
                </p>
              </div>
              ...
              <div 
                ...
                className="rounded-lg border bg-card p-6 hover:shadow-md transition-all cursor-pointer group mb-4"
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-start justify-between gap-2 mb-2">
                      ...
                      <span className="inline-flex items-center rounded-full bg-green-500/10 px-2 py-0.5 text-xs font-medium text-green-600 dark:text-green-400 ring-1 ring-inset ring-green-500/20">
                        Online
                      </span>
                    </div>
                    <p className="text-sm text-muted-foreground leading-relaxed">
                      Ask about my technical skills, projects, competition achievements, or career goals. Powered by Groq AI and Upstash Vector.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid gap-4 sm:grid-cols-2 mb-6">
                ...
                <ContactCard
                  ...
                  title="Email"
                  subtitle="justinpmarcos@gmail.com"
                ...
                <ContactCard
                  ...
                  bgColor="bg-foreground/10 group-hover:bg-foreground/20"
                />
                ...
                <div className="rounded-lg border bg-gradient-to-br from-primary/5 to-transparent p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="font-semibold mb-2">Local Time</h3>
                      <PhilippineTime />
                      <p className="text-xs text-muted-foreground mt-2">
                        I typically respond as soon as I can.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="text-center">
                <p className="text-xs text-muted-foreground">
                  Open to opportunities • Available for freelance work • Let&apos;s build something great!
                </p>
              </div>
            </div>
          </div>
